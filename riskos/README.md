...
[![CI](https://github.com/VinayK88/Data-Science-Projects/actions/workflows/riskos-ci.yml/badge.svg)](https://github.com/VinayK88/Data-Science-Projects/actions/workflows/riskos-ci.yml)
...
Repository-level CI lives in `.github/workflows/riskos-ci.yml` and runs only when RiskOS files change. It tests Python 3.11 and 3.12, executes the demo, runs the threshold optimizer, and syntax-checks the dashboard.
